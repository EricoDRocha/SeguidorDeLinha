...
Como utilizamos o servor motor e eles so vão de 0 (rodando para um lado) 90 (parado) até 180(rodando para outro lado) e como utilizamos variaveis para controlar a o valor a saida final, que chamamos de "Output" que estaria entre 0 e 180, se esses valores ou ficassem menor que zero ou maior que 180 ele pagava um valor completamente aleatório.
